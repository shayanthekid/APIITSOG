...
class ImportExportController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        // Build a consultant name→id map for lookup
        ...
        foreach ($rows as $index => $row) {
            ...
            $consultantName = strtolower(trim($row['education consultant name'] ?? $row['consultant'] ?? ''));
            $consultantId   = $consultants->get($consultantName)?->id ?? null;
    ...
    public function export(Request $request)
    {
        ...
        $rows = $students->map(function ($s) {
            ...
            return [
                'Name'                      => $s->name,
                'Education Consultant Name' => $s->consultant?->name ?? '',
                'Number'                    => $s->phone ?? '',
