...
ok('Each student has consultant rel',    isset($firstStudent['consultant']));
...
if ($createdId) {
    ...
    ok('GET includes consultant relation',     isset($getRes->json()['consultant']));
